...
public class GenericEcommerceController implements Initializable{
	...
	// New setters for shared properties
	public void setStage(Stage stage) {
		this.stage = stage;
	}

	public void setManageEcommerceController(ManageEcommerceController manageEcommerceController) {
		this.manageEcommerceController = manageEcommerceController;
	}
	...
	protected Ecommerce toObject(boolean isEdit){
		...
		try {
			...
			ecommerce.setImageUrl(txtImageUrl.getText());
		}catch (Exception e){
	...
	protected void setFields(String action){
		...
		txtImageUrl.setText(ecommerce.getImageUrl());
	}
	...
	protected void enableFields(boolean enable){
		...
		txtImageUrl.editableProperty().set(enable);
	}
