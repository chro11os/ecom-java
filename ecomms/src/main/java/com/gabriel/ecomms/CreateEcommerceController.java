...
public class CreateEcommerceController extends GenericEcommerceController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			Ecommerce ecommerce = toObject(false);
			Ecommerce newEcommerce = EcommerceService.getService().create(ecommerce);
